...
public class CustomTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    private Logger logger = LoggerFactory.getLogger(CustomTokenServices.class);
    ...
    public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
        logger.debug("create access token for username {}", authentication.getPrincipal().toString());
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        logger.debug("refresh access token with value {}", refreshTokenValue);
        ...
        OAuth2AccessToken accessToken = createAccessToken(authentication, refreshToken);
        logger.debug("re store access token with new access token {} and authentication {}", accessToken.getValue(), authentication.getPrincipal().toString());
        tokenStore.storeAccessToken(accessToken, authentication);
        if (!reuseRefreshToken) {
            logger.debug("reuseRefreshToken active, re store refresh token {}", accessToken.getRefreshToken().getValue());
    ...
    public OAuth2Authentication loadAuthentication(String accessTokenValue) throws AuthenticationException,
        ...
        logger.debug("check clientDetailsService instance {}", clientDetailsService);
    ...
    protected int getAccessTokenValiditySeconds(OAuth2Request clientAuth) {
        logger.debug("client details service is status {} ", clientDetailsService);
        if (clientDetailsService != null) {
